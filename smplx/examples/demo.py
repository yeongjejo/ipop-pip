...
def main(model_folder,
    ...
    print('gender :', gender)
    print('use_face_contour :', use_face_contour)
    print('num_betas :', num_betas)
    print('num_expression_coeffs :', num_expression_coeffs)
    print('ext :', ext)
    ...
    output, test = model(betas=betas, expression=expression,
                   return_verts=True)
